...
class User(UserMixin, db.Model):
    ...
    company_description = db.Column(db.Text)  # For employers
...
class Application(db.Model):
    ...
    status = db.Column(db.String(50), default='applied')  # applied, under_review, interview, rejected, accepted
...
def job_seeker_dashboard():
    ...
    return render_template('job_seeker_dashboard.html', applications=applications, saved_jobs=saved_jobs)
...
def upload_resume():
    ...
    # Check if user has reached limit (3 resumes)
